...
if (add.new.data){
  ...
  sco.i.e.title <- "Scottish Local Government Finance Statistics 2017-18 Annex A by LA"
  ...
  ################################################################################
#I have left this out for now
    # title as it will appear in the references:
  sco.aberdeen.title <- "{Aberdeen City Council Annual Accounts 2017-18}"
  
  # url of the file:
  sco.aberdeen.url <- "https://www.aberdeencity.gov.uk/sites/default/files/2018-05/Unaudited%20Annual%20Accounts%20Aberdeen%20City%20Council%202017-18.pdf"
  
  # year published, as it will appear in the references:
  sco.aberdeen.year.published <- 2018
  
  ## replace with date of access to data:
  sco.aberdeen.date.accessed <- "24.4.2023"
  
  # How much parking Income did Aberdeen City report this year??#  (£,000s)  Section 18
sco.aberdeen.income.total <- 8397
  
  # How much parking Expenditure did Aberdeen City report this year??(£,000s)  Section 18
  sco.aberdeen.expend.total <- 5075
...
and Expenditure: 2016 to 2017"
  ...
  # url of the file:
  sco.pdf.url <- "https://www.transport.gov.scot/publication/decriminalised-parking-enforcement-local-authorities-income-and-expenditure-2017-to-2018/"
