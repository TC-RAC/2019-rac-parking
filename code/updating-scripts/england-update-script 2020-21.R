...
if (add.new.data){
  ...
  eng.i.e.title <- "Local authority revenue expenditure and financing England: 2021-21, individual local authority data - outturn"
  ...
  eng.i.e.url <- "https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/1112587/RO2_2020-21_data_by_LA.ods"
  
  # year published, as it will appear in the references:
  eng.i.e.year.published <- 2022

  ## replace with date of access to data:
  eng.i.e.date.accessed <- "13.04.2023"

  # path and name of file where you have saved it:
  eng.i.e.file <- "data/01-raw/orig.eng-20-21.xlsx"
  ...
  #############################################################################
  # title as it will appear in the references:
  eng.budg.title <- "Local authority revenue expenditure and financing England: 2021 to 2022 budget (Revenue Account budget)"
  
  # url of the file:
  eng.budg.url <- "https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/996209/RA_2021-22_data_by_LA.ods"
  
  # year published, as it will appear in the references:
  eng.budg.year.published <- 2021
  
  ## replace with date of access to data:
  eng.budg.date.accessed <- "13.04.2023"
  
  # path and name of file where you have saved it:
  eng.budg.file <- "data/01-raw/orig.eng-21-22-budget.xlsx"
